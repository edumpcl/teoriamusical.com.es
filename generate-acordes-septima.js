'use strict';
// Pentagramas de los 5 tipos de acorde de septima sobre Do (VexFlow + Playwright).
// Salida: assets/img/acordes/*.png  (webp aparte)
...
// file, keys (de grave a agudo). El acc se deduce de la clave (eb -> b, bbb -> bb).
const CHORDS = [
  { file: 'septima-dominante',  keys: ['c/4', 'e/4',  'g/4',  'bb/4'] },   // Do Mi Sol Si♭  (C7)
  { file: 'septima-mayor',      keys: ['c/4', 'e/4',  'g/4',  'b/4'] },    // Do Mi Sol Si   (Cmaj7)
  { file: 'septima-menor',      keys: ['c/4', 'eb/4', 'g/4',  'bb/4'] },   // Do Mi♭ Sol Si♭ (Cm7)
  { file: 'septima-sensible',   keys: ['c/4', 'eb/4', 'gb/4', 'bb/4'] },   // Do Mi♭ Sol♭ Si♭ (semidisminuido)
  { file: 'septima-disminuida', keys: ['c/4', 'eb/4', 'gb/4', 'bbb/4'] },  // Do Mi♭ Sol♭ Si♭♭ (°7)
];
...
async function main() {
  ...
  await browser.close();
  console.log('Done: ' + CHORDS.length + ' acordes.');
}
