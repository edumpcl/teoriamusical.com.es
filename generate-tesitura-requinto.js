'use strict';
// Un mini-pentagrama por registro del requinto (clarinete en Mi♭). Notas ESCRITAS,
// clave de sol: mismo rango y registros que el clarinete (Mi3–La6).
// Registros: chalumeau Mi3–Fa♯4; garganta Sol4–Si♭4; clarín Si4–Do6; sobreagudo Do♯6–La6.
const { chromium } = require('playwright');
const path = require('path');
const fs = require('fs');

const VEXFLOW_PATH = path.join(__dirname, 'node_modules/vexflow/build/cjs/vexflow.js');
const OUTPUT_DIR = path.join(__dirname, 'assets/img/requinto');
fs.mkdirSync(OUTPUT_DIR, { recursive: true });

const ITEMS = [
  ['tesitura-chalumeau',  ['e/3', 'f#/4'],  95],
  ['tesitura-garganta',   ['g/4', 'bb/4'], 110],
  ['tesitura-clarin',     ['b/4', 'c/6'],  120],
  ['tesitura-sobreagudo', ['c#/6', 'a/6'], 138],
];
