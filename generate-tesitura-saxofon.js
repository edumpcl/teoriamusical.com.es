'use strict';
// Un mini-pentagrama por registro del saxofón (Si♭3–Fa♯6 ESCRITOS, clave de sol,
// idéntico para los cuatro miembros de la familia).
// Registros: grave Si♭3–Do♯5; agudo Re5–Do♯6; sobreagudo Re6–Fa♯6.
const { chromium } = require('playwright');
const path = require('path');
const fs = require('fs');

const VEXFLOW_PATH = path.join(__dirname, 'node_modules/vexflow/build/cjs/vexflow.js');
const OUTPUT_DIR = path.join(__dirname, 'assets/img/saxofon');
fs.mkdirSync(OUTPUT_DIR, { recursive: true });

const ITEMS = [
  ['tesitura-grave',      ['bb/3', 'c#/5'], 110, 'treble'],
  ['tesitura-agudo',      ['d/5', 'c#/6'],  110, 'treble'],
  ['tesitura-sobreagudo', ['d/6', 'f#/6'],  110, 'treble'],
];
