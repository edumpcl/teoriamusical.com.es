/* Motor de ejercicios — Escalas Menores (natural, armónica, melódica ascendente) */
(function () {
  'use strict';
  ...
  /* 7º grado elevado un semitono respecto a la menor natural */
  var SCALES_ARMONICA = [
  ...
  /* 6º y 7º grados elevados un semitono (forma ascendente) */
  var SCALES_MELODICA = [
  ...
  var SCALES_MELODICA_15 = SCALES_MELODICA.map(function (mel, i) {
  ...
  var CSS = [
    ...
    '.tmesc-wrap .tm-hn:hover:not(:disabled){border-color:#8b6914;background:#fdf8ee;color:#1a1a1a;}',
    ...
    '.tmesc-wrap .tm-ha:hover:not(:disabled){border-color:#8b6914;background:#fdf8ee;color:#1a1a1a;}',
  ...
  function tmEscMenores(containerId, tipo) {
    injectCSS();
    ...
    function renderHardOpts() {
      ...
      ACC_OPTS.forEach(function (a) {
        ...
        b.addEventListener('click', function () {
          ...
          var chosen = selRoot + a.val + ' menor ' + tipo;
  ...
  window.tmEscMenores = tmEscMenores;
})();
