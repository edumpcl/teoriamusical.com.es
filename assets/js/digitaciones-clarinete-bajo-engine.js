...
(function () {
  ...
  var CSS = [
    ...
    '.tm-cb-svg{display:block;height:min(72vh,560px);width:auto;max-width:100%;margin:0 auto;}',
  ...
  function tmClarineteBajoEngine(containerId) {
    ...
    wrap.innerHTML =
      '<div class="tm-cb-wrap">' +
        ...
        '<div class="tm-cb-diagram"><svg class="tm-cb-svg" viewBox="0 0 300 ' + SVG_W + '" role="img" aria-label="Diagrama de digitación del clarinete bajo: instrumento en vertical (como se toca), con la boquilla y el cuello curvado arriba y la campana metálica abajo; las llaves pulsadas se muestran en dorado">' +
