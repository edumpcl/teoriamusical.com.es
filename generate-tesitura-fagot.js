'use strict';
// Un mini-pentagrama por registro del fagot (Si♭1–Mi♭5).
// Registros: grave Si♭1–Sol2; medio La♭2–Sol3; agudo La♭3–Sol4; sobreagudo La♭4–Mi♭5.
...
const OUTPUT_DIR = path.join(__dirname, 'assets/img/fagot');
fs.mkdirSync(OUTPUT_DIR, { recursive: true });

const ITEMS = [
  ['tesitura-grave',      ['bb/1', 'g/2'],  100, 'bass'],
  ['tesitura-medio',      ['ab/2', 'g/3'],  110, 'bass'],
  ['tesitura-agudo',      ['ab/3', 'g/4'],  115, 'tenor'],
  ['tesitura-sobreagudo', ['ab/4', 'eb/5'], 112, 'treble'],
];
