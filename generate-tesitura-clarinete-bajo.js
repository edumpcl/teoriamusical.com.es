'use strict';
// Un mini-pentagrama por registro del clarinete en Siâ™­ (notas ESCRITAS, clave de sol).
// Registros: chalumeau Mib3–Fa#4; garganta Sol4–Sib4; clarín Si4–Do6; sobreagudo Do#6–La6.
const { chromium } = require('playwright');
const path = require('path');
const fs = require('fs');

const VEXFLOW_PATH = path.join(__dirname, 'node_modules/vexflow/build/cjs/vexflow.js');
const OUTPUT_DIR = path.join(__dirname, 'assets/img/clarinete-bajo');
fs.mkdirSync(OUTPUT_DIR, { recursive: true });

const ITEMS = [
  ['tesitura-chalumeau',  ['eb/3', 'f#/4'], 95],
