...
// Registros: grave Re4–Si4; medio Do5–Si5; agudo Do6–Do7.
const { chromium } = require('playwright');
const path = require('path');
const fs = require('fs');

const VEXFLOW_PATH = path.join(__dirname, 'node_modules/vexflow/build/cjs/vexflow.js');
const OUTPUT_DIR = path.join(__dirname, 'assets/img/flautin');
fs.mkdirSync(OUTPUT_DIR, { recursive: true });

const ITEMS = [
  ['tesitura-grave',  ['d/4', 'b/4'],  112],
  ['tesitura-medio',  ['c/5', 'b/5'],  120],
  ['tesitura-agudo',  ['c/6', 'c/7'],  140],
];
