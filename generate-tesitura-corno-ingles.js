...
// Registros (escritos): grave Si3–Sol4; medio Lab4–Sol5; agudo Lab5–Re6; sobreagudo Mib6–Sol6.
const { chromium } = require('playwright');
const path = require('path');
const fs = require('fs');

const VEXFLOW_PATH = path.join(__dirname, 'node_modules/vexflow/build/cjs/vexflow.js');
const OUTPUT_DIR = path.join(__dirname, 'assets/img/corno-ingles');
fs.mkdirSync(OUTPUT_DIR, { recursive: true });

const ITEMS = [
  ['tesitura-grave',      ['b/3', 'g/4'],  108],
  ['tesitura-medio',      ['ab/4', 'g/5'], 116],
  ['tesitura-agudo',      ['ab/5', 'd/6'], 128],
  ['tesitura-sobreagudo', ['eb/6', 'g/6'], 136],
];
